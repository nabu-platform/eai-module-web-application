(function() {
    ...
    (function() {
        ...
        this.sliceArray = function(array, index) {
            var slice = [];
            for (var i = index; i < array.length;
                ++i) {
                slice.push(array[i])
            }
            return slice
        ...
        this.iterateWindows = function(win, handler) {
            ...
            for (var i = 0; i < win.frames.length;
                ++i) {
        ...
        this.isColorKeyword = function(keyword) {
            ...
            if (!cssColorNames) {
                ...
                for (var i = 0; i < systemColors.length;
                    ++i) {
        ...
        with(FBL) {
            ...
            FBL.Firebug = {
                ...
                registerPanel: function() {
                    ...
                    for (var i = 0, panelType; panelType = arguments[i];
                        ++i) {
            ...
            Firebug.Panel = {
                ...
                markChange: function(skipSelf) {
                    if (this.dependents) {
                        if (skipSelf) {
                            for (var i = 0; i < this.dependents.length;
                                ++i) {
    ...
    (function() {
        ...
        FBL.DomplateTag.prototype = {
                ...
                for (var i = 0; i < this.children.length;
                    ...
                    if (isTag(child)) {
                        ...
                        if (child instanceof Parts) {
                            for (var i = 0; i < child.parts.length;
                                ++i) {
            ...
            compileDOM: function() {
                ...
                for (var i = 0; i < path.staticIndex;
                    ++i) {
                    fnBlock.push(", ", "s" + i)
                }
                for (var i = 0; i < path.renderIndex;
                    ++i) {
                    fnBlock.push(", ", "d" + i)
                }
                fnBlock.push(") {");
                for (var i = 0; i < path.loopIndex;
                    ++i) {
                    fnBlock.push("var l", i, " = 0;")
                }
                for (var i = 0; i < path.embedIndex;
                    ++i) {
        ...
        FBL.DomplateLoop.prototype = copyObject(FBL.DomplateTag.prototype, {
            ...
            generateMarkup: function(topBlock, topOuts, blocks, info) {
                ...
                if (this.iter instanceof Parts) {
                    ...
                    iterName = part.name;
                    if (part.format) {
                        for (var i = 0; i < part.format.length;
                            ++i) {
        ...
        function readPartNames(val, vars) {
            if (val instanceof Parts) {
                for (var i = 0; i < val.parts.length;
                    ++i) {
            ...
            if (val instanceof Parts) {
                ...
                for (var i = 0; i < val.parts.length;
                    ...
                    if (part instanceof Variable) {
                        ...
                        if (part.format) {
                            for (var j = 0; j < part.format.length;
                                ++j) {
        ...
        with(FBL) {
                                    ...
                                    if (attr.nodeName == "class") {
                                        ...
                                        if (attr.nodeName == "style") {
                                            attrs.push({
                                                ...
                                                nodeValue: attr.nodeValue || elt.style.cssText.replace(/([^\s]+)\s*:/g, function(m, g) {
            ...
            this.StackFrame = domplate(Firebug.Rep, {
                ...
                argIterator: function(frame) {
                    ...
                    var items = [];
                    for (var i = 0; i < frame.args.length;
                        ++i) {
            ...
            this.SourceText = domplate(Firebug.Rep, {
                ...
                lineIterator: function(sourceText) {
                    ...
                    var list = [];
                    for (var i = 0; i < sourceText.lines.length;
                        ++i) {
                        var lineNo = (i + 1) + "";
            ...
            Firebug.Spy = extend(Firebug.Module, {
                ...
                updateOption: function(name, value) {
                    if (name == "showXMLHttpRequests") {
                        ...
                        for (var i = 0; i < TabWatcher.contexts.length;
                            ++i) {
        ...
        with(FBL) {
            ...
            Firebug.ConsolePanel.prototype = extend(Firebug.Panel, {
                ...
                appendFormatted: function(objects, row, rep) {
                    ...
                    for (var i = objIndex + 1; i < objects.length;
                        ++i) {
                        logText(" ", row);
            ...
            var FirebugConsoleHandler = function FirebugConsoleHandler(context, win) {
                ...
                this.trace = function() {
                    ...
                    for (var fn = arguments.callee.caller.caller; fn; fn = fn.caller) {
                        ...
                        var args = [];
                        for (var i = 0, l = fn.arguments.length; i < l;
                            ++i) {
                            args.push({
        ...
        with(FBL) {
            ...
            Firebug.Reps = {
                ...
                appendArray: function(object, html) {
                    ...
                    for (var i = 0, l = object.length, obj; i < l;
                        ++i) {
        ...
        with(FBL) {
            ...
            Firebug.CSSStyleSheetPanel.prototype = extend(Firebug.SourceBoxPanel, {
                ...
                addOldProperties: function(context, ruleId, inheritMode, props) {
                    if (context.selectorMap && context.selectorMap.hasOwnProperty(ruleId)) {
                        ...
                        for (var i = 0; i < moreProps.length;
                            ++i) {
            ...
            CSSElementPanel.prototype = extend(Firebug.CSSStyleSheetPanel.prototype, {
                ...
                getElementRules: function(element, rules, usedProps, inheritMode) {
                    ...
                    if (inspectedRules) {
                        for (var i = 0, length = inspectedRules.length; i < length;
                            ++i) {
                ...
                markOverridenProps: function(props, usedProps, inheritMode) {
                    for (var i = 0; i < props.length;
                        ...
                        if (usedProps.hasOwnProperty(prop.name)) {
                            ...
                            for (var j = 0; j < deadProps.length;
                                ++j) {
        ...
        with(FBL) {
            ...
            Firebug.DOMBasePanel.prototype = extend(Firebug.Panel, {
                ...
                showMembers: function(members, update, scrollTop) {
                    if (this.timeouts) {
                        for (var i = 0; i < this.timeouts.length;
                            ++i) {
                ...
                findPathObject: function(object) {
                    var pathIndex = -1;
                    for (var i = 0; i < this.objectPath.length;
                        ++i) {
                ...
                ishow: function(state) {
                    if (this.context.loaded && !this.selection) {
                        ...
                        if (this.propertyPath.length > 1) {
                            for (var i = 1; i < this.propertyPath.length;
                                ++i) {
                ...
                updateSelection: function(object) {
                    ...
                    if (newPath || pathIndex == -1) {
                        ...
                        if (newPath) {
                            ...
                            for (var i = 0, length = newPath.length; i < length;
                                ++i) {
                                var name = newPath[i];
                                var object = value;
                                try {
            ...
            function expandMembers(members, toggles, offset, level) {
                var expanded = 0;
                for (var i = offset; i < members.length;
                    ++i) {
